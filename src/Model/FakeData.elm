...
exampleResources =
  ...
  , Resource "Friendly Introduction to Machine Learning - YouTube" "https://www.youtube.com/watch?v=IpGxLWOIZy4" "picodegree" "2016" (Set.fromList [ "video", "course" ]) (Dict.singleton attrTextWorkload ".5")
  ...
  , Resource "Machine Learning is Fun! – Adam Geitgey – Medium" "https://medium.com/@ageitgey/machine-learning-is-fun-80ea3ec3c471" "ageitgey" "2014" (Set.fromList [ "article", "entertaining" ]) (Dict.singleton attrTextWorkload ".3")
  ...
  , Resource "Tokyo Machine Learning Society" "https://www.meetup.com/tokyomachinelearning/" "meetup_tokyo" "" (Set.fromList [ "meetup", "tokyo" ]) (Dict.singleton attrTextWorkload "2")
